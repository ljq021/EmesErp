...
using MahApps.Metro;
using Emes.CodeGen.Models;
using System.Windows.Input;
using MahApps.Metro.Controls;
using MahApps.Metro.Controls.Dialogs;
using Emes.CodeGen.Core;
using Emes.CodeGen.ExampleViews;
using NHotkey;
using NHotkey.Wpf;
    ...
    public class MainWindowViewModel : ViewModelBase, IDataErrorInfo, IDisposable
    {
        ...
        public MainWindowViewModel(IDialogCoordinator dialogCoordinator)
        {
            ...
            this.FlipViewImages = new Uri[]
                                  {
                                      new Uri("pack://application:,,,/Emes.CodeGen;component/Assets/Photos/Home.jpg", UriKind.RelativeOrAbsolute),
                                      new Uri("pack://application:,,,/Emes.CodeGen;component/Assets/Photos/Privat.jpg", UriKind.RelativeOrAbsolute),
                                      new Uri("pack://application:,,,/Emes.CodeGen;component/Assets/Photos/Settings.jpg", UriKind.RelativeOrAbsolute)
                                  };
