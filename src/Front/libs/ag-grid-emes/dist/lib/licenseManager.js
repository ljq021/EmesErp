...
var LicenseManager = /** @class */ (function () {
    ...
    LicenseManager.prototype.validateLicense = function () {
        ...
        else if (!ag_grid_community_1._.missingOrEmpty(LicenseManager_1.licenseKey) &&
            LicenseManager_1.licenseKey.length > 32) {
            if (LicenseManager_1.licenseKey === "fvD4zeQKw67tN/bhxuXOVhHoftG6m6u0lFIsoOGscUiow/oOO6xc1N6VWJmZPKieP+lf10o6M7CrfG9vdAoP5w8pDMeEAxxIWxctucV9LhlIE5+tvI0EwfN125PrUFDqSeVKUobgS1Vps4PRVv/iqhwgEvEMO6tK9Kd+XNBkcXM=") {
                return;
            }
    ...
    LicenseManager.extractBracketedInformation = function (licenseKey) {
        ...
        var version = matches
            .filter(function (match) { return match.startsWith("v"); })
            .map(function (match) { return match.replace(/^v/, ""); })[0];
